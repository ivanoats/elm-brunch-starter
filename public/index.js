...
Elm.Index.make = function (_elm) {
   ...
   _U.list([A2($Html.hr,_U.list([]),_U.list([]))
           ,A2($Html.a,
           _U.list([$Html$Attributes.href("https://github.com/ivanoats/elm-brunch-starter")]),
           _U.list([$Html.text("Made with the Elm-Brunch-Starter")]))]));
   ...
   var NoOp = {ctor: "NoOp"};
   var newEntry = F2(function (text,id) {
      return {text: text,id: id};
   });
   var initialModel = {entries: _U.list([A2(newEntry,"Seattle",1)
                                        ,A2(newEntry,"Portland",2)
                                        ,A2(newEntry,"Vancouver",3)
                                        ,A2(newEntry,"Eureka",4)])};
